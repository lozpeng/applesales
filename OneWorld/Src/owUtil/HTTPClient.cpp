...
#include <owUtil/ThreadingUtils.h>
...
{
    ProgressBase* callback = (ProgressBase*)clientp;
...
HTTPResponse
HTTPClient::doGet( const HTTPRequest& request, const osgDB::ReaderWriter::Options* options, ProgressBase* callback) const
{
    ...
    osg::ref_ptr<ProgressBase> progressCallback = callback;
...
HTTPResponse
HTTPClient::doGet( const std::string& url, const osgDB::ReaderWriter::Options* options, ProgressBase* callback) const
{
