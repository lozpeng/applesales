/**********************************************************************
 * $Id: AbstractPreparedPolygonContains.cpp 2194 2008-09-23 23:01:00Z mloskot $
 *
...
#include <Geometry/geom/prep/AbstractPreparedPolygonContains.h>
...
AbstractPreparedPolygonContains::isProperIntersectionImpliesNotContainedSituation( const geom::Geometry * testGeom)
{
	...
	if (	testGeom->getGeometryTypeId() == GEOMETRY::geom::GEOS_MULTIPOLYGON  
		||	testGeom->getGeometryTypeId() == GEOMETRY::geom::GEOS_POLYGON )
		return true;
