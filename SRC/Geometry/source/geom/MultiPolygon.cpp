/**********************************************************************
 * $Id: MultiPolygon.cpp 1820 2006-09-06 16:54:23Z mloskot $
 *
...
bool MultiPolygon::IsContainArc() const
{
	Polygon *p =NULL;

	for(size_t i=0;i<geometries->size();i++)
	{
		p =dynamic_cast<Polygon*>((*geometries)[i]);
		if(p)
		{
			if(p->IsContainArc())
			{
...
*
******************************************************************************************************/
void MultiPolygon::Move(double dx, double dy)
{
	for(size_t i=0;i<geometries->size();i++)
	{
...
void MultiPolygon::Mirror(const Coordinate &p1,const Coordinate &p2)
{
...
void MultiPolygon::Scale(const GEOMETRY::geom::Coordinate &OriginPt, double dx, double dy)
{
	for(size_t i=0;i<geometries->size();i++)
	{
...
void MultiPolygon::Rotate(const Coordinate &OriginPt,double angle)
{
	for(size_t i=0;i<geometries->size();i++)
	{
...
*
******************************************************************************************************/
long MultiPolygon::PointCount() const
{
