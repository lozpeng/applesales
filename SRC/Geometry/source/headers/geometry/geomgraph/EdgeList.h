/**********************************************************************
 * $Id: EdgeList.h 2220 2008-11-11 17:32:38Z pramsey $
 *
...
#ifndef GEOMETRY_GEOMGRAPH_EDGELIST_H
#define GEOMETRY_GEOMGRAPH_EDGELIST_H

#include <vector>
#include <string>
#include <iostream>

#include <Geometry/indexQuadtree.h> // for inlined ctor
...
private:
	 ...
	 *
	 */
	GEOMETRY::index::SpatialIndex* index;
...
public:
	...
	EdgeList()
		:
		edges(),
		index(new GEOMETRY::index::quadtree::Quadtree())
	{}
...
//#ifdef GEOS_INLINE
//# include "Geometry/geomgraph/EdgeList.inl"
//#endif
