/**********************************************************************
 * $Id: WKTWriter.h 1820 2006-09-06 16:54:23Z mloskot $
 *
...
protected:
	...
	void appendCircleTaggedText(const geom::Circle *circle,
		int level,Writer *writer) ;

	void appendEllipseTaggedText(const geom::Ellipse* ellipse, int level,
		Writer *writer);

	void appendBezierSplineTaggedText(const geom::BezierSpline* bezierSpline, int level,
		Writer *writer);
	...
	void appendCircleText(const geom::Circle* circle, int /*level*/,
		Writer *writer);

	void appendEllipseText(const geom::Ellipse* ellipse, int /*level*/,
		Writer *writer);

	void appendBezierSplineText(const geom::BezierSpline* bezierSpline, int /*level*/,
		Writer *writer);
