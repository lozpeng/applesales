// otRasterLayer.h : CotRasterLayer 的声明
...
class ATL_NO_VTABLE CotRasterLayer :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CotRasterLayer, &CLSID_otRasterLayer>,
	public IotRasterLayer,
	public IOriginData
{
public:
	CotRasterLayer();
...
DECLARE_REGISTRY_RESOURCEID(IDR_OTRASTERLAYER)


BEGIN_COM_MAP(CotRasterLayer)
	COM_INTERFACE_ENTRY(IotRasterLayer)
...
private:
	bool CheckPointer();
private:
	Carto::CRasterLayerPtr *m_ppLayer;
	bool m_bAutoDestroy;

public:
	STDMETHOD(get_TransparentValue)(LONG* pVal);
	STDMETHOD(put_TransparentValue)(LONG newVal);
	STDMETHOD(Enhance)(RasterEnhanceType type);
	STDMETHOD(SetBrightAndContrast)(LONG bright, LONG contrast);
};

OBJECT_ENTRY_AUTO(__uuidof(otRasterLayer), CotRasterLayer)
