...
static UINT _propButtons[] =
{
	...
	ID_WIZBACK, ID_WIZNEXT, ID_WIZFINISH,IDC_BTN_NEXT,IDC_BTN_PREV,IDC_BTN_HELP,IDC_BTN_CANCEL
};
...
CResizableSheetHook::CResizableSheetHook(CMyPropertySheet* const pSheet)
 : m_pSheet(pSheet)
{
  ASSERT( m_pSheet );
...
LRESULT CResizableSheetHook::WindowProc(UINT nMsg,WPARAM wParam,LPARAM lParam)
{
  ...
  {
	  m_pSheet->DoMyWndProc(nMsg,wParam,lParam);
  }*/
