// otLineRing.cpp : CotLineRing 的实现

#include "stdafx.h"
#include "otLineRing.h"
#include "InterfaceConvert.h"

// CotLineRing

CotLineRing::CotLineRing()
{
	m_pGeometry =GEOMETRY::geom::GeometryFactory::getDefaultInstance()->createLinearRing();
	m_bAutoDestroy =true;
}
...
*
***************************************************************************************/
STDMETHODIMP CotLineRing::IsClosed(VARIANT_BOOL* bRet)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::get_Length(DOUBLE* pVal)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::get_StartPoint(IotPoint** pVal)
{
	if(!m_pGeometry)
	{
		*pVal =NULL;
...
STDMETHODIMP CotLineRing::put_StartPoint(IotPoint* newVal)
{
...
STDMETHODIMP CotLineRing::get_EndPoint(IotPoint** pVal)
{
	if(!m_pGeometry)
	{
		*pVal =NULL;
...
STDMETHODIMP CotLineRing::put_EndPoint(IotPoint* newVal)
{
	if(!m_pGeometry)
	{
...
* 实现IOriginData接口
******************************************************************************/
STDMETHODIMP CotLineRing::get_OriginData(long * pVal)
{
...
STDMETHODIMP CotLineRing::put_OriginData(long  pVal)
{
	...
	m_pGeometry =(GEOMETRY::geom::LinearRing*)(pVal);

	return S_OK;
}

STDMETHODIMP CotLineRing::get_AutoDestroy(long * pVal)
{
...
STDMETHODIMP CotLineRing::put_AutoDestroy(long  pVal)
{
...
STDMETHODIMP CotLineRing::get_GeometryType( otGeometryType * pVal)
{
	*pVal =OT_GEOM_LINERING;
	return S_OK;
}
STDMETHODIMP CotLineRing::get_PointCount( LONG * pVal)
{
	if(!m_pGeometry)
	{
...
STDMETHODIMP CotLineRing::GetEnvelope( IotEnvelope * * envelope)
{
...
STDMETHODIMP CotLineRing::get_HasZ( VARIANT_BOOL * pVal)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::put_HasZ( VARIANT_BOOL newVal)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::get_HasM( VARIANT_BOOL * pVal)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::put_HasM( VARIANT_BOOL newVal)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::get_IsEmpty( VARIANT_BOOL * pVal)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::SetEmpty()
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::Clone( IotGeometry * * geometry)
{
...
STDMETHODIMP CotLineRing::get_IsValid( VARIANT_BOOL * pVal)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::Disjoint( IotGeometry * other,  VARIANT_BOOL * bRet)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::Touches( IotGeometry * other,  VARIANT_BOOL * bRet)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::Intersects( IotGeometry * other,  VARIANT_BOOL * bRet)
{
...
STDMETHODIMP CotLineRing::Crosses( IotGeometry * other,  VARIANT_BOOL * bRet)
{
...
STDMETHODIMP CotLineRing::Within( IotGeometry * other,  VARIANT_BOOL * bRet)
{
...
STDMETHODIMP CotLineRing::Overlaps( IotGeometry * other,  VARIANT_BOOL * bRet)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::Equals( IotGeometry * other,  VARIANT_BOOL * bRet)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::Covers( IotGeometry * other,  VARIANT_BOOL * bRet)
{
...
STDMETHODIMP CotLineRing::ConvexHull( IotGeometry * * retGeometry)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::Buffer( DOUBLE distance,  IotGeometry * * retGeometry)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::Intersection( IotGeometry * other,  IotGeometry * * retGeometry)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::Union( IotGeometry * other,  IotGeometry * * retGeometry)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::Difference( IotGeometry * other,  IotGeometry * * retGeometry)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::SymDifference( IotGeometry * other,  IotGeometry * * retGeometry)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::get_Point(LONG index, IotPoint **pVal)
{
...
STDMETHODIMP CotLineRing::get_PointNum(LONG *pVal)
{
	if(!m_pGeometry)
	{
...
STDMETHODIMP CotLineRing::InsertPoint(LONG index, IotPoint *point)
{
	if(!m_pGeometry)
	{
...
STDMETHODIMP CotLineRing::RemovePoint(LONG index)
{
	if(!m_pGeometry)
	{
...
STDMETHODIMP CotLineRing::ReplacePoint(LONG index, IotPoint *point)
{
	if(!m_pGeometry)
	{
...
STDMETHODIMP CotLineRing::AddPoint(IotPoint *point)
{
	if(!m_pGeometry)
	{
...
STDMETHODIMP CotLineRing::Move(DOUBLE dx, DOUBLE dy)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::Scale(IotPoint * Origin,  DOUBLE dx,  DOUBLE dy)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::Rotate( IotPoint * Origin,  DOUBLE angle)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::get_SegmentCount( LONG * pVal)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::AddSegment(IotSegment * segment)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
...
STDMETHODIMP CotLineRing::GetSegment(LONG index,  IotSegment * * ret)
{
	if(!m_pGeometry)
	{
		return E_FAIL;
