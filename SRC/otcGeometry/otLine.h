...
class ATL_NO_VTABLE CotLine :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CotLine, &CLSID_otLine>,
	public IotLine,
	public IOriginData,
	public IotGeometry
{
public:
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_OTLINE)


	BEGIN_COM_MAP(CotLine)
		COM_INTERFACE_ENTRY(IotLine)
...
private:
	//保存Circle的指针
	GEOMETRY::geom::Line *m_pGeometry;
	bool m_bAutoDestroy;  
	
};

OBJECT_ENTRY_AUTO(__uuidof(otLine), CotLine)
