...
#include "ActionPolygonSubstract.h"
...
namespace otEditor
{
	...
	CActionPolygonSubstract::CActionPolygonSubstract(void) : IAction("ActionPolygonSubstract")
	{
		RegisterAction("ActionPolygonSubstract", this);
	}
	...
	void CActionPolygonSubstract::Triger()
	{
		//获取活动地图控件
