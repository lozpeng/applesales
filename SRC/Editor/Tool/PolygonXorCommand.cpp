...
namespace Editor
{
	...
	CActionPolygonXor::CActionPolygonXor(void) : ICommand("ActionPolygonXor")
	{
	...
	//初始化
	void CActionPolygonXor::Initialize(Framework::IUIObject *pTargetControl)
	{
		ICommand::Initialize(pTargetControl);
	}
	void CActionPolygonXor::Click()
	{
		//获取活动地图控件
