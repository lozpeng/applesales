/************************************************************************
 *
 * $Id: geos_ts_c.cpp 2509 2009-05-13 12:35:00Z warmerdam $
 *
...
#include <Geometry/operation/polygonize/Polygonizer.h>
...
GEOSRelate_r(GEOSContextHandle_t extHandle, const Geometry *g1, const Geometry *g2)
{
	...
	using GEOMETRY::geom::IntersectionMatrix;
	try {
...
GEOSisValid_r(GEOSContextHandle_t extHandle, const Geometry *g1)
{
	...
	using GEOMETRY::operation::valid::IsValidOp;
	using GEOMETRY::operation::valid::TopologyValidationError;
	IsValidOp ivo(g1);
	bool result;
	try {
		result = ivo.isValid();
...
GEOSUnionCascaded_r(GEOSContextHandle_t extHandle, const Geometry *g1)
{
	...
	try{
		const GEOMETRY::geom::MultiPolygon *p = dynamic_cast<const GEOMETRY::geom::MultiPolygon *>(g1);
		if ( ! p ) 
		{
...
GEOSGetGeometryN_r(GEOSContextHandle_t extHandle, const Geometry *g1, int n)
{
	...
	using GEOMETRY::geom::GeometryCollection;
	try{
...
GEOSPolygonize_r(GEOSContextHandle_t extHandle, const Geometry * const * g, unsigned int ngeoms)
{
	...
	using GEOMETRY::operation::polygonize::Polygonizer;
	unsigned int i;
	Geometry *out = NULL;
...
GEOSLineMerge_r(GEOSContextHandle_t extHandle, const Geometry *g)
{
	...
	using GEOMETRY::operation::linemerge::LineMerger;
        unsigned int i;
        Geometry *out = NULL;
...
GEOSGeom_createPolygon_r(GEOSContextHandle_t extHandle, Geometry *shell, Geometry **holes, unsigned int nholes)
{
    ...
    using GEOMETRY::geom::LinearRing;
	try
	{
...
GEOSSimplify_r(GEOSContextHandle_t extHandle, const Geometry *g1, double tolerance)
{
	...
	using namespace GEOMETRY::simplify;
...
{
    const GEOMETRY::geom::prep::PreparedGeometry* prep = NULL;
    ...
    try
	{
		prep = GEOMETRY::geom::prep::PreparedGeometryFactory::prepare(g);
	}
	catch (const std::exception &e)
	{
		handle->ERROR_MESSAGE("%s", e.what());
...
void
GEOSPreparedGeom_destroy_r(GEOSContextHandle_t extHandle, const GEOMETRY::geom::prep::PreparedGeometry *a)
{
    GEOSContextHandleInternal_t *handle;
...
char
GEOSPreparedContains_r(GEOSContextHandle_t extHandle, const GEOMETRY::geom::prep::PreparedGeometry *pg1, const Geometry *g2)
{
    GEOSContextHandleInternal_t *handle;
...
char
GEOSPreparedContainsProperly_r(GEOSContextHandle_t extHandle, const GEOMETRY::geom::prep::PreparedGeometry *pg1, const Geometry *g2)
{
    GEOSContextHandleInternal_t *handle;
...
char
GEOSPreparedCovers_r(GEOSContextHandle_t extHandle, const GEOMETRY::geom::prep::PreparedGeometry *pg1, const Geometry *g2)
{
    GEOSContextHandleInternal_t *handle;
...
char
GEOSPreparedIntersects_r(GEOSContextHandle_t extHandle, const GEOMETRY::geom::prep::PreparedGeometry *pg1, const Geometry *g2)
{
    GEOSContextHandleInternal_t *handle;
