/**********************************************************************
 * $Id: OffsetCurveSetBuilder.cpp 2131 2008-07-15 22:04:51Z mloskot $
 *
...
using namespace GEOMETRY::noding; // SegmentString
using namespace GEOMETRY::geomgraph; // Label, Position
using namespace GEOMETRY::algorithm; // CGAlgorithms
