/**********************************************************************
 * $Id: WKTReader.h 1820 2006-09-06 16:54:23Z mloskot $
 *
...
protected:
	...
	geom::Circle* readCircleText(io::StringTokenizer *tokenizer);
	geom::Ellipse* readEllipseText(io::StringTokenizer *tokenizer);
	geom::BezierSpline* readBezierSplineText(io::StringTokenizer *tokenizer);
private:
