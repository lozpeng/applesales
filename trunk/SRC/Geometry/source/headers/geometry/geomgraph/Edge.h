/**********************************************************************
 * $Id: Edge.h 1986 2007-06-08 15:27:42Z mloskot $
 *
...
#ifndef GEOMETRY_GEOMGRAPH_EDGE_H
#define GEOMETRY_GEOMGRAPH_EDGE_H

#include <string>
#include <cassert>

#include <Geometry/geomgraph/GraphComponent.h> // for inheritance
#include <Geometry/geomgraph/Depth.h> // for member
#include <Geometry/geomgraph/EdgeIntersectionList.h> // for composition
#include <Geometry/geom/CoordinateSequence.h> // for inlines
...
//#ifdef GEOS_INLINE
//# include "Geometry/geomgraph/Edge.inl"
//#endif
