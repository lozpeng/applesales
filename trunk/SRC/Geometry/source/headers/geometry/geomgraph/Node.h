/**********************************************************************
 * $Id: Node.h 1986 2007-06-08 15:27:42Z mloskot $
 *
...
#ifndef GEOMETRY_GEOMGRAPH_NODE_H
#define GEOMETRY_GEOMGRAPH_NODE_H

#include <Geometry/geomgraph/GraphComponent.h> // for inheritance
#include <Geometry/geom/Coordinate.h> // for member

#ifndef NDEBUG
#include <Geometry/geomgraph/EdgeEndStar.h> // for testInvariant
#include <Geometry/geomgraph/EdgeEnd.h> // for testInvariant
#endif // ndef NDEBUG
...
//#ifdef GEOS_INLINE
//# include "Geometry/geomgraph/Node.inl"
//#endif
