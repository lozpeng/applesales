/**********************************************************************
 * $Id: CoordinateSequence.h 1958 2007-01-09 15:08:22Z strk $
 *
...
#ifndef GEOMETRY_GEOM_COORDINATESEQUENCE_H
#define GEOMETRY_GEOM_COORDINATESEQUENCE_H

#include <Geometry/platform.h>
#include <Geometry/inline.h>

#include <Geometry/geom/Coordinate.h> // for applyCoordinateFilter
...
public:
	...
	virtual  Coordinate& getAt(size_t i) const=0;
    ...
    //添加一个节点
	virtual void insert(size_t pos,const Coordinate& c)=0;

	//清除所有的点
	virtual void ClearAll() =0;

	//得到一个点的指针
    virtual Coordinate *GetPtPointer(size_t i) =0 ;
...
//#ifdef GEOS_INLINE
//# include "Geometry/geom/CoordinateSequence.inl"
//#endif
