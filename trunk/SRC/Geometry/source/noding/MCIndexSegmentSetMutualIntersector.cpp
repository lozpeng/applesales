/**********************************************************************
 * $Id: MCIndexSegmentSetMutualIntersector.cpp 2196 2008-10-04 18:14:09Z pramsey $
 *
...
#include <Geometry/index/SpatialIndex.h>
...
using namespace GEOMETRY::index::chain;
...
index(new GEOMETRY::index::strtree::STRtree()),
indexCounter(0),
processCounter(0),
nOverlaps(0)
{
