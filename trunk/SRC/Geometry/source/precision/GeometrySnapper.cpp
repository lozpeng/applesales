...
#include <Geometry/precision/LineStringSnapper.h>
#include <Geometry/geom/util/GeometryTransformer.h> // inherit. of SnapTransformer
...
class SnapTransformer: public GEOMETRY::geom::util::GeometryTransformer {
