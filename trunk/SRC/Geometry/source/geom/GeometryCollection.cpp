/**********************************************************************
 * $Id: GeometryCollection.cpp 2040 2007-12-13 16:09:25Z mloskot $
 *
...
void GeometryCollection::AddGeometry(Geometry *pGeometry)
{
	geometries->push_back(pGeometry);
}

long GeometryCollection::GeometryCount()
{
	return geometries->size();
}

Geometry* GeometryCollection::GetGeometry(size_t i)
{
