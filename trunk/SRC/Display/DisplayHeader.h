...
//enum SYS_UNIT_TYPE
//{
//	SYSTEM::SYS_UNIT_PIXEL = 0,
//	SYSTEM::SYS_UNIT_MILLIMETER = 1,
//	SYSTEM::SYS_UNIT_CENTIMETER = 10,
//	SYSTEM::SYS_UNIT_DECIMETER = 100,
//	POINT	=200
//};
...
typedef enum SymbolType
{
	...
	NONE_SYMBOL = 0x01, //空符号
	MARKER_SYMBOL = 0x10,
	LINE_SYMBOL = 0x20,
	FILL_SYMBOL = 0x40,
	EXT_SYMBOL = 0x80, 
	COMPLEX_SYMBOL = 0x0100,
	TEXT_SYMBOL = 0x0200,//文字符号
