...
public:
	...
	*/
	...
	//将图元增量文件保存
	void IncrementalExport(std::string incrementalFile,std::string tagertLayerName_P,std::string tagertLayerName_L,std::string tagertLayerName_A,bool bExportAll);
