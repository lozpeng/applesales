...
/*! @brief Base class for CTreePropSheetEx
  ...
  @date 07/2004 */
#define SUPER_PROPERTYSHEET CMyPropertySheet
class WSEXT_CLASS CTreePropSheetBase
 : public SUPER_PROPERTYSHEET//CPropertySheet
{
...
protected:		
	...
	//以下函数子类重载
	//下一步
	virtual int DoCustomNext();
	//上一步
	virtual int DoCustomPrev();
	//跳过
	virtual int DoCustomSkip();
	//添加更新按钮状态的函数
