// otArrowMarkerSymbol.h : CotArrowMarkerSymbol 的声明
...
class ATL_NO_VTABLE CotArrowMarkerSymbol :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CotArrowMarkerSymbol, &CLSID_otArrowMarkerSymbol>,
	public IotArrowMarkerSymbol,
	public IOriginData
{
public:
	CotArrowMarkerSymbol();
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_OTARROWMARKERSYMBOL)


	BEGIN_COM_MAP(CotArrowMarkerSymbol)
		COM_INTERFACE_ENTRY(IotArrowMarkerSymbol)
...
private:
	...
	Display::CArrowMarkerSymbol *m_pMarkerSymbol;

	bool m_bAutoDestroy;
};

OBJECT_ENTRY_AUTO(__uuidof(otArrowMarkerSymbol), CotArrowMarkerSymbol)
