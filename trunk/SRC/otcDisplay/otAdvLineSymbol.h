// otAdvLineSymbol.h : CotAdvLineSymbol 的声明
...
class ATL_NO_VTABLE CotAdvLineSymbol :
	public CComObjectRootEx<CComSingleThreadModel>,
	public CComCoClass<CotAdvLineSymbol, &CLSID_otAdvLineSymbol>,
	public IotAdvLineSymbol,
	public IOriginData
{
public:
	CotAdvLineSymbol();
	...
	DECLARE_REGISTRY_RESOURCEID(IDR_OTADVLINESYMBOL)


	BEGIN_COM_MAP(CotAdvLineSymbol)
		COM_INTERFACE_ENTRY(IotAdvLineSymbol)
...
private:
	...
	Display::CAdvLineSymbol *m_pLineSymbol;

	bool m_bAutoDestroy;
};

OBJECT_ENTRY_AUTO(__uuidof(otAdvLineSymbol), CotAdvLineSymbol)
